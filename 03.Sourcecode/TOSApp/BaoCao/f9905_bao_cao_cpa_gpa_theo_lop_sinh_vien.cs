...
namespace TOSApp.BaoCao
{
    public partial class f9905_bao_cao_cpa_gpa_theo_lop_sinh_vien : Form
    {
        ...
        private void load_data_2_grid()
        {
            ...
            v_us.FillDatasetWithQuery(v_ds, "select * from v_sinh_vien_gpa where id_lop_sinh_vien=" + m_cbo_lop_sinh_vien.SelectedValue + "and id_hoc_ky=" + m_cbo_ky_hoc.SelectedValue + " order by ma_sinh_vien");
